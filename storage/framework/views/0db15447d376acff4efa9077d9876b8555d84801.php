                        ...
                        <input type="hidden" name="admin_id" value="<?php echo e(Auth::id()); ?>">
                            ...
                            <tbody>
                                ...
                                <tr class="line">
                                    ...
                                    <?php if($conf->level == 0): ?>
                                        <td><button type="button" class="btn btn-warning confCheck" value="1" data-route="<?php echo e(route('conf.update',$conf->id)); ?>" data-id="<?php echo e($conf->id); ?>">Check !</button></td>
                                    <?php else: ?>
                                        <td><button type="button" class="btn btn-success confCheck" value="0" data-route="<?php echo e(route('conf.update',$conf->id)); ?>" data-id="<?php echo e($conf->id); ?>">Checked !</button></td>
                                    <?php endif; ?>
