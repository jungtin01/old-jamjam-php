                    ...
                    <div class="row">
                        <table id="miyazaki" class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="line">
                                    <td class="username success"><a role='button' data-toggle="modal" data-target="#myModal"><?php echo e($user->username); ?></a></td>
                                    <td><a href='javascript:void(0)'>None</a></td>
                                    <td class="form-group"><input type="text" name="level" value="<?php if($user->level == 0): ?> User <?php else: ?> Admin <?php endif; ?>" class="form-control" disabled="disabled"></td>
