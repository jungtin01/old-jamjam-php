                        ...
                        <table id="miyazaki" class="table table-striped table-hover">
                            ...
                            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="line">
                                    ...
                                    <td>
                                        <?php if($post->level == 0): ?>
                                        <button type="button" class="btn btn-warning check" value="1" data-id="<?php echo e($post->id); ?>">Check !</button>
                                    <?php else: ?>
                                        <button type="button" class="btn btn-success check" value="0" data-id="<?php echo e($post->id); ?>">Checked !</button>
                                    <?php endif; ?>
                                    </td>
